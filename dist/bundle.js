...
exports.testObjVal = exports.sum = undefined;

var _plus = __webpack_require__(329);
...
var sum = exports.sum = function sum() {
  ...
  return numbers.reduce(function (result, number) {
    return (0, _plus.plus)(result, number);
  }, 0);
};

var testObjVal = exports.testObjVal = function testObjVal(obj) {
  return Object.values(obj);
};

window.addEventListener('load', function () {
  document.getElementById('testbtn').onclick = function () {
    alert(JSON.stringify(testObjVal({ 1: 'val1', 2: 'val2', 3: 'val3' })));
  };
});
...
var plus = exports.plus = function plus(a, b) {
  return a + b;
};
